...
namespace LightSwitch.Ide.VS
{
    ...
    internal sealed class MainCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("e106afdc-8cf3-472d-a4c1-0b2a0a1306ee");
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await this.package.ShowToolWindowAsync(typeof(Main), 0, true, this.package.DisposalToken);
